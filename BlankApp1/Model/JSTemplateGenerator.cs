   ...
   public class JSTemplateGenerator: IFillForm, IDownloadDelegation, IAcceptDelegation
    {
        ...
        public string FillFormWithData(string FirstName, string Name, DateTime FromDate, DateTime ToDate, string CompanyName, string Location, string Purpose, string CashAdvance)
        {
